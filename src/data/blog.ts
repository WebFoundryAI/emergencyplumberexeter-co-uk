...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    metaDescription: "Learn the early warning signs of a blocked drain in Exeter. From slow drainage to bad smells, know when to call a professional before it becomes an emergency.",
    excerpt: "Catching a blocked drain early can save you hundreds of pounds in emergency repairs. Here are the key warning signs every Exeter homeowner should know.",
...
If you're experiencing a complete blockage, our [blocked drain specialists](/services/blocked-drains/) are available 24/7 across [Exeter](/locations/exeter/) and surrounding areas. For urgent situations, our [emergency drain service](/services/emergency-drain-services/) guarantees a rapid response.

Call us on ${BRAND.phoneFormatted} for a no-obligation quote, or [contact us online](/contact/) to book an appointment.`,
    author: "Emergency Plumber Exeter",
  ...
  },
  {
    ...
    metaTitle: "Prevent Kitchen Drain Blockages | Exeter Tips",
    metaDescription: "Stop kitchen drain blockages before they start. Expert tips on preventing grease buildup, food waste disposal, and maintaining clear drains in your Exeter home.",
    ...
    content: `Kitchen drains handle more abuse than any other drain in your home. Between cooking oils, food scraps, soap residue, and everything else that goes down the sink, it's no wonder they're the most frequently blocked drains we see in Exeter homes.
...
Contact ${BRAND.brandName} on ${BRAND.phoneFormatted} for expert advice and assistance, or [get in touch online](/contact/).`,
  ...
  },
  {
    ...
    metaTitle: "CCTV Drain Survey Before Buying | Exeter Guide",
    metaDescription: "Buying a house in Exeter? Discover why a pre-purchase CCTV drain survey could save you thousands and give you negotiating power.",
...
Many of our Exeter customers have negotiated thousands off their purchase price after our surveys revealed drain problems the seller wasn't aware of.
...
At ${BRAND.brandName}, we provide comprehensive [pre-purchase drain surveys](/services/cctv-drain-surveys/pre-purchase-survey/) across [Exeter](/locations/exeter/) and Exeter and surrounding areas. Our engineers explain exactly what they find and provide honest advice about any issues.
...
Book your [CCTV drain survey](/services/cctv-drain-surveys/) today by calling ${BRAND.phoneFormatted} or [contact us online](/contact/).`,
  ...
  },
  {
    ...
    metaDescription: "Experiencing a drain emergency in Exeter? Learn what to do immediately to minimise damage while waiting for professional help to arrive.",
...
We aim to arrive within 1-2 hours for [emergency callouts across Exeter](/locations/exeter/emergency-drain-services/) and Exeter and surrounding areas. Our [emergency drain services](/services/emergency-drain-services/) team is available 24 hours a day, 7 days a week.
...
Call us immediately on ${BRAND.phoneFormatted} if you're experiencing a drain emergency, or [request urgent help online](/contact/).`,
  ...
  },
  {
    ...
    metaTitle: "Drain Jetting vs Rods | Exeter Comparison",
    metaDescription: "Should you use drain rods or high-pressure jetting to clear a blockage? Our Exeter drainage experts explain when each method works best.",
...
When you call us for a blocked drain in Exeter, we typically:
...
For reliable [drain clearing across Exeter](/locations/exeter/drain-jetting/), call ${BRAND.brandName} on ${BRAND.phoneFormatted} or [request a quote online](/contact/). We also cover [Topsham](/locations/topsham/), [Exmouth](/locations/exmouth/), and [Crediton](/locations/crediton/).`,
    author: "Emergency Plumber Exeter",
